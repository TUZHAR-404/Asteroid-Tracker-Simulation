...
# ----------------------------
UI_TEXT = {
    "title": {"en":"FloodSafe Dashboard", "hi":"फ़्लडसेफ डैशबोर्ड", "bn":"ফ্লাডসেফ ড্যাশবোর্ড", "ta":"ப்ளட்ஸேஃப் டாஷ்போர்டு"},
    "subtitle": {"en":"Real-time flood monitoring and management system", "hi":"रीयल-टाइम बाढ़ निगरानी और प्रबंधन प्रणाली", "bn":"রিয়েল-টাইম বন্যা পর্যবেক্ষণ ও ব্যবস্থাপনা সিস্টেম", "ta":"நேரடி வெள்ள கண்காணிப்பு மற்றும் நிர்வாகம்"},
    ...
    if city_input:
        try:
            ...
            if geo:
                ...
                st.success(f"Using coords for {city_input}: {geo[0]['lat']:.6f}, {geo[0]['lon']:.6f}")
            else:
